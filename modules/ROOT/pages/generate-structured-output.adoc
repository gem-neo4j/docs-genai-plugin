...
:provider: openai
include::partial$generate-structured-output.adoc[tag=recipes]
...
:provider: openai
include::partial$generate-structured-output.adoc[tag=classification]
...
:provider: openai
include::partial$generate-structured-output.adoc[tag=sentiment-analysis]
