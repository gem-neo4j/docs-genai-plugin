...
=====
The example below provides the model with a list of movie titles and plots, alongside a few movie genres, and asks to sort the movies into genres.
...
.Sentiment analysis
=====
The example below asks the model to classify reviews (either `positive`, `negative`, or `neutral`) and to summarize the review into a `reson`.
